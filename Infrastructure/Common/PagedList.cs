...
namespace Infrastructure.Common
{
    ...
    public static class PagedListExtensions
    {
        ...
        public static PagedList<T> ToPagedList<T>(this IEnumerable<T> items, int page, int size) where T : class
        {
            return PagedList<T>.ToPagedList(items, page, size);
        }

        public static async Task<PagedList<T>> ToPagedListAsync<T>(this IQueryable<T> items, QueryFilter filter) where T : class
        {
